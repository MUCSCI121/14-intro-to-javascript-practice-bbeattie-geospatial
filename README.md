[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-7f7980b617ed060a017424585567c406b6ee15c891e84e1186181d67ecf80aa0.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=14260667)
# JavaScript practice
We will practice the following topics:
* Writing JavaScript in an HTML file
* Referencing an external JavaScript file in an HTML file
* Creating functions that return values, don't return values, and call other functions.
* Assigning the value from a function return to a variable
